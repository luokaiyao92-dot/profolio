/**
 * [INPUT]: 依赖 React 的 useEffect/useRef，以及 Hero 传入的背景图片 URL 和浏览器 WebGL/Pointer 能力
 * [OUTPUT]: 对外提供 LiquidHover 背景渲染器，以流体速度场和压力迭代响应鼠标划过并扭曲图片纹理
 * [POS]: src 的 Hero 媒体层，只处理背景像素与 GPU 生命周期，不接管前景文案、导航或页面状态
